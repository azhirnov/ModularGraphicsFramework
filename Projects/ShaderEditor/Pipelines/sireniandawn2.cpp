...
"
                              ...
                              Decorate 30 Binding 1
                              Decorate 43(out_Color0) Location 0
                              Decorate 52(iChannel0) DescriptorSet 0
                              Decorate 52(iChannel0) Binding 0
               3:             TypeVoid
               4:             TypeFunction 3
               7:             TypeFloat 32
               8:             TypeVector 7(float) 4
...
19(gl_FragCoord):     18(ptr) Variable Input
 ...
 28(ShadertoyUB):             TypeStruct 8(fvec4) 7(float) 7(float) 22(int) 7(float) 25 26 8(fvec4) 8(fvec4) 7(float) 7(float) 7(float) 7(float) 27 8(fvec4)
  ...
  43(out_Color0):     42(ptr) Variable Output
   ...
   52(iChannel0):     51(ptr) Variable UniformConstant
              55:             TypePointer Uniform 8(fvec4)
              62:    7(float) Constant 1065353216
         5(main):           3 Function None 4
               6:             Label
...
15(mainImage(vf4;vf2;):           3 Function None 12
   ...
   14(fragCoord):     11(ptr) FunctionParameter
              16:             Label
                              Line 1 120 0
              53:          50 Load 52(iChannel0)
              54:   10(fvec2) Load 14(fragCoord)
              56:     55(ptr) AccessChain 30 31
              57:    8(fvec4) Load 56
              58:   10(fvec2) VectorShuffle 57 57 0 1
              59:   10(fvec2) FDiv 54 58
              60:    8(fvec4) ImageSampleImplicitLod 53 59
              61:   32(fvec3) VectorShuffle 60 60 0 1 2
              63:    7(float) CompositeExtract 61 0
              64:    7(float) CompositeExtract 61 1
              65:    7(float) CompositeExtract 61 2
              66:    8(fvec4) CompositeConstruct 63 64 65 62
                              Store 13(fragColor) 66
                              Return
                              FunctionEnd
)#"_str );
