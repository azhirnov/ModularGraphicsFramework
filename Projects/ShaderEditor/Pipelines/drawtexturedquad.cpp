...
// Created at: 2017/12/26 - 19:29:37
...
void main ()
{
	gl_Position=float4( g_Positions[gl_VertexID], float(0.0), float(1.0) );
}
...
0x000200F8, 0x00000006, 0x0004003B, 0x0000001E, 0x0000001F, 0x00000007, 0x00040008, 0x00000001, 0x00000068, 0x00000000, 0x0004003D, 0x0000000F, 
...
void main ()
{
	out_Color=texelFetch( un_ColorTexture, int2( gl_FragCoord.xy ), int(0) );
}
