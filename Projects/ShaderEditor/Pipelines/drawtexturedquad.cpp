...
// Created at: 2018/02/02 - 00:31:57
...
// Id's are bound by 27
               ...
               2:             ExtInstImport  "GLSL.std.450"
                              MemoryModel Logical GLSL450
                              EntryPoint Fragment 5  "main" 10 17
...
"
                              ...
                              Name 5  "main"
                              Name 10  "out_Color"
                              Name 14  "un_ColorTexture"
                              Name 17  "gl_FragCoord"
                              Decorate 10(out_Color) Location 0
                              Decorate 14(un_ColorTexture) DescriptorSet 0
                              Decorate 14(un_ColorTexture) Binding 0
                              Decorate 17(gl_FragCoord) BuiltIn FragCoord
               3:             TypeVoid
               4:             TypeFunction 3
               7:             TypeFloat 32
               8:             TypeVector 7(float) 4
               9:             TypePointer Output 8(fvec4)
   10(out_Color):      9(ptr) Variable Output
              11:             TypeImage 7(float) 2D sampled format:Unknown
              12:             TypeSampledImage 11
              13:             TypePointer UniformConstant 12
14(un_ColorTexture):     13(ptr) Variable UniformConstant
              16:             TypePointer Input 8(fvec4)
17(gl_FragCoord):     16(ptr) Variable Input
         ...
         5(main):           3 Function None 4
               6:             Label
                              Line 1 91 0
              15:          12 Load 14(un_ColorTexture)
              19:    8(fvec4) Load 17(gl_FragCoord)
              20:   18(fvec2) VectorShuffle 19 19 0 1
              23:   22(ivec2) ConvertFToS 20
              25:          11 Image 15
              26:    8(fvec4) ImageFetch 25 23 Lod 24
                              Store 10(out_Color) 26
                              Return
                              FunctionEnd
)#"_str );
