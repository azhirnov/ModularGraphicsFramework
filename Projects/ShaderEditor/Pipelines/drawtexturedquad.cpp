...
// Created at: 2017/12/30 - 21:34:51
...
const float2 g_Positions[4] = { float2(-1.0, 1.0), float2(-1.0), float2(1.0), float2(1.0, -1.0) };
const float C_float_0 = float(0.0);
const float C_float_1 = float(1.0);
...
void main ()
{
	gl_Position=float4( g_Positions[gl_VertexID], C_float_0, C_float_1 );
}
...
0x000200F8, 0x00000006, 0x0004003B, 0x0000001E, 0x0000001F, 0x00000007, 0x00040008, 0x00000001, 0x00000069, 0x00000000, 0x0004003D, 0x0000000F, 
...
void main ()
{
	out_Color=texelFetch( un_ColorTexture, int2( gl_FragCoord.xy ), C_int_0 );
}
...
0x00050036, 0x00000003, 0x00000005, 0x00000000, 0x00000004, 0x000200F8, 0x00000006, 0x00040008, 0x00000001, 0x00000062, 0x00000000, 0x0004003D, 
