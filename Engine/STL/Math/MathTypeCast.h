...
namespace GXMath
{
	...
	struct TypeCast final : public Noninstancable
	{
		...
		inline static Vec<T,I,U>  ToUNorm (const Vec<T,I,U> &value)
		{
			Vec<T,I,U>		res;
		...
		inline static Vec<T,I,_UID_UNORM>  ToUNorm (const Vec<T,I,_UID_SNORM> &value)
		{
		...
		template <typename T, usize I, ulong U>
		inline static Vec<T,I,U>  ToSNorm (const Vec<T,I,U> &value)
		{
			Vec<T,I,U>		res;
		...
		template <typename T, usize I>
		inline static Vec<T,I,_UID_SNORM>  ToSNorm (const Vec<T,I,_UID_UNORM> &value)
		{
		...
		inline static Vec<R,I,U>  UNormToInt (const Vec<T,I,U> &value)
		{
			Vec<R,I,U>		res;
		...
		inline static Vec<R,I>  UNormToInt (const Vec<T,I,_UID_UNORM> &value)
		{
			Vec<R,I>		res;
			FOR( i, res )	res[i] = UNormToInt<R>( value[i] );
			return res;
		...
		template <typename R, typename T, usize I, ulong U>
		inline static Vec<R,I,U>  SNormToInt (const Vec<T,I,U> &value)
		{
			Vec<R,I,U>		res;
		...
		template <typename R, typename T, usize I>
		inline static Vec<R,I>  SNormToInt (const Vec<T,I,_UID_SNORM> &value)
		{
			Vec<R,I>		res;
			FOR( i, res )	res[i] = SNormToInt<R>( value[i] );
			return res;
		...
		/*template <typename R, typename T, usize I, ulong U>
		inline static Vec<R,I,U>  IntToUNorm (const Vec<T,I,U> &value)
		{
			Vec<R,I,U>		res;
		...
		template <typename R, typename T, usize I, ulong U>
		inline static Vec<R,I,_UID_UNORM>  IntToUNorm (const Vec<T,I,U> &value)
		{
		...
		/*template <typename R, typename T, usize I, ulong U>
		inline static Vec<R,I,U>  IntToSNorm (const Vec<T,I,U> &value)
		{
			Vec<R,I,U>		res;
		...
		template <typename R, typename T, usize I, ulong U>
		inline static Vec<R,I,_UID_SNORM>  IntToSNorm (const Vec<T,I,U> &value)
		{
