...
namespace GXMath
{
	...
	// Sign (1 or -1)
		ND_ static int Sign (const int = 0)
		{
			return SetSign( 1, Bool() );
		}
		
		template <usize I, ulong U>
		ND_ static Vec<int,I,U> Sign (const Vec<int,I,U> = Uninitialized)
		{
			return SetSign( Vec<int,I,U>(1), Bool<I>() );
		}

		template <typename T>
		ND_ static T SignVec ()
		{
			return Sign( T() );
		}
	...
	// Sign Or Zero (-1, 0, 1)
		ND_ static int SignOrZero (const int = 0)
		{
		...
		template <usize I, ulong U>
		ND_ static Vec<int,I,U> SignOrZero (const Vec<int,I,U> = Uninitialized)
		{
			Vec<int,I,U>	res;
	...
	// Boolean
		ND_ static bool Bool (const bool = false)
		{
			return RndEngine()() & 1;
		}
		
		template <usize I, ulong U>
		ND_ static Vec<bool,I,U> Bool (const Vec<bool,I,U> & = Uninitialized)
		{
			Vec<bool,I,U>	res;
	...
	// Integer
		...
		ND_ static Vec<T,I,U> Int (const Vec<T,I,U> & = Uninitialized)
		{
			Vec<T,I,U>		res;
	...
	// Float
		...
		template <typename T, usize I, ulong U>
		ND_ static Vec<T,I,U> Float (const Vec<T,I,U> & = Uninitialized)
		{
			Vec<T,I,U>		res;
	...
	// Float Unsigned Normalized	0.0 ... 1.0
		...
		template <typename T, usize I, ulong U>
		ND_ static Vec<T,I,U> UNorm (const Vec<T,I,U> & = Uninitialized)
		{
			Vec<T,I,U>		res;
	...
	// Float Signed Normalized	-1.0 ... 1.0
		...
		template <typename T, usize I, ulong U>
		ND_ static Vec<T,I,U> SNorm (const Vec<T,I,U> & = Uninitialized)
		{
			Vec<T,I,U>		res;
	...
	// Float In Range
		template <typename T>
		ND_ static T FloatRange (const T& minValue, const T& maxValue)
		{
		...
		template <typename T, usize I, ulong U>
		ND_ static Vec<T,I,U> FloatRange (const Vec<T,I,U> &minValue, const Vec<T,I,U> &maxValue)
		{
			Vec<T,I,U>		res;
	...
	// Integer In Range
		...
		template <typename T, usize I, ulong U>
		ND_ static Vec<T,I,U> IntRange (const Vec<T,I,U> &minValue, const Vec<T,I,U> &maxValue)
		{
			Vec<T,I,U>		res;
	...
	// Range
		template <typename T>
		ND_ static T Range (const T& minValue, const T& maxValue)
		{
			return IntRange( minValue, maxValue );
		}
		
		template <typename T, usize I, ulong U>
		ND_ static Vec<T,I,U> Range (const Vec<T,I,U> &minValue, const Vec<T,I,U> &maxValue)
		{
			return IntRange( minValue, maxValue );
		}
