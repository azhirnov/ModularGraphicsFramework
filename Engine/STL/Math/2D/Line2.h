...
*/
	template <typename T, ulong U>
	CHECKRES inline bool  Line2<T,U>::operator == (const Self &right) const
	{
...
*/
	template <typename T, ulong U>
	CHECKRES inline T  Line2<T,U>::GetXfromY (T y) const
	{
		// ax + by + c = 0 -> x = -(by + c) / a
...
*/
	template <typename T, ulong U>
	CHECKRES inline T  Line2<T,U>::GetYfromX (T x) const
	{
		// y = kx + b
		T	k, b;
		GetEquation( k, b );
...
*/
	template <typename T, ulong U>
	CHECKRES inline typename Line2<T,U>::Vec_t  Line2<T,U>::GetFromY (T y) const
	{
...
*/
	template <typename T, ulong U>
	CHECKRES inline typename Line2<T,U>::Vec_t  Line2<T,U>::GetFromX (T x) const
	{
...
*/
	template <typename T, ulong U>
	CHECKRES inline bool  Line2<T,U>::PerpendicularBase (const Vec_t &p, OUT Vec_t &base) const
	{
		Vec_t	vec		= End() - Begin();
...
*/
	template <typename T, ulong U>
	CHECKRES inline bool  Line2<T,U>::Perpendicular (const Vec_t &point, OUT Self &result) const
	{
		Vec_t	base;
...
*/
	template <typename T, ulong U>
	CHECKRES inline T  Line2<T,U>::MinDistance (const Vec_t &point) const
	{
		T	a, b, c;
		GetEquation( a, b, c );
...
*/
	template <typename T, ulong U>
	CHECKRES inline Vec<T,2,U>  Line2<T,U>::Normal () const
	{
...
*/
	template <typename T, ulong U>
	CHECKRES inline Vec<T,2,U>  Line2<T,U>::LeftNormal () const
	{
		const Vec_t	v = Vector();
...
*/
	template <typename T, ulong U>
	CHECKRES inline Vec<T,2,U>  Line2<T,U>::RightNormal () const
	{
		const Vec_t	v = Vector();
		return Vec_t( v.y, -v.x ).Normalized();
	}
...
*/
	template <typename T, ulong U>
	CHECKRES inline bool  Line2<T,U>::IsInnerPoint (const Vec_t &point) const
	{
		Rect_t	r;
		GetBoundingRect( r );
...
*/
	template <typename T, ulong U>
	CHECKRES inline bool  Line2<T,U>::IsInnerLine (const Self &line) const
	{
		Rect_t	r;
		GetBoundingRect( r );
...
*/
	template <typename T, ulong U>
	CHECKRES inline bool  Line2<T,U>::IntersectLine (const Self &other) const
	{
		Vec_t	res;
...
*/
	template <typename T, ulong U>
	CHECKRES inline bool  Line2<T,U>::IntersectRect (const Rect_t &other) const
	{
		Vec_t	res0, res1;
...
*/
	template <typename T, ulong U>
	CHECKRES inline bool  Line2<T,U>::IsPointInBoundingRects (const Self &other, const Vec_t &point) const
	{
		Rect_t	r0;
		Rect_t	r1;
...
*/
	template <typename T, ulong U>
	CHECKRES inline Radians<T>  Line2<T,U>::AngleBetweenLines (const Self &other) const
	{
...
*/
	template <typename T, ulong U>
	CHECKRES inline T  Line2<T,U>::CosBetweenLines (const Self &other) const
	{
		const Vec_t	v0 = Vector();
		const Vec_t	v1 = other.Vector();
...
*/
	template <typename T, ulong U>
	CHECKRES inline bool  Rectangle<T,U>::IsInnerLine (const Line2<T,U> &other) const
	{
...
*/
	template <typename T, ulong U>
	CHECKRES inline bool  Rectangle<T,U>::IntersectLine (const Line2<T,U> &other) const
	{
...
*/
	template <typename T, ulong U>
	CHECKRES inline Line2<T,U>  Rectangle<T,U>::Left () const
	{
...
*/
	template <typename T, ulong U>
	CHECKRES inline Line2<T,U>  Rectangle<T,U>::Right () const
	{
...
*/
	template <typename T, ulong U>
	CHECKRES inline Line2<T,U>  Rectangle<T,U>::Bottom () const
	{
...
*/
	template <typename T, ulong U>
	CHECKRES inline Line2<T,U>  Rectangle<T,U>::Top () const
	{
...
namespace GXTypes
{
	...
	{
		CHECKRES HashResult  operator () (const GXMath::Line2<T,U> &x) const noexcept
		{
			return HashOf( x.Begin() ) + HashOf( x.End() );
		}
	};
