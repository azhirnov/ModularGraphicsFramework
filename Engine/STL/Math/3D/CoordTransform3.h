...
*/
	template <typename T>
	ND_ inline Vec<T,3>  CartesianToSpherical (const Vec<T,3> &cartesian)
	{
...
*/
	template <typename T>
	ND_ inline Vec<T,3>  SphericalToCartesian (const Vec<T,3> &spherical)
	{
		CompileTime::MustBeFloat<T>();
...
*/
	template <typename T>
	ND_ inline Vec<T,3>  SphericalToCilindrical (const Vec<T,3> &spherical)
	{
		CompileTime::MustBeFloat<T>();
...
*/
	template <typename T>
	ND_ inline Vec<T,3>  CilindricalToSpherical (const Vec<T,3> &cilindrical)
	{
		CompileTime::MustBeFloat<T>();
...
*/
	template <typename T>
	ND_ inline Vec<T,3>  CartesianToCilindrical (const Vec<T,3> &cartesian)
	{
		CompileTime::MustBeFloat<T>();
...
*/
	template <typename T>
	ND_ inline Vec<T,3>  CilindricalToCartesian (const Vec<T,3> &cilindrical)
	{
		CompileTime::MustBeFloat<T>();
