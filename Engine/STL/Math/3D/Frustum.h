...
*/	
	template <typename T>
	ND_ inline bool  Frustum<T>::IsVisible (const Vec<T,3> &point) const
	{
...
*/
	template <typename T>
	ND_ inline bool  Frustum<T>::IsVisible (const AABBox<T> &box) const
	{
...
*/
	template <typename T>
	ND_ inline bool  Frustum<T>::IsVisible (const Vec<T,3> &center, const T radius) const
	{
...
*/
	template <typename T>
	ND_ inline bool  Frustum<T>::IsVisible (const Vec<T,3> &center, const Vec<T,3> &halfextents) const
	{
		typedef typename Plane<T>::ESide		PSide;
...
*/
	/*template <typename T>
	ND_ inline bool  Frustum<T>::IsVisible (const Frustum<T> &frustum) const
	{
...
*/
	template <typename T>
	template <typename T2>
	ND_ inline Frustum<T2>  Frustum<T>::Convert () const
	{
		Frustum<T2>	ret;
