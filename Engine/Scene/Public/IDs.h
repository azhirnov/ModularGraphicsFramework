...
// Renderer Objects //
	...
	static constexpr OModID::type  OffscreenSurfaceModuleID		= "s.offscsurf"_OModID;
	static constexpr OModID::type  VideoRecordeerSurfaceModuleID= "s.videosurf"_OModID;
