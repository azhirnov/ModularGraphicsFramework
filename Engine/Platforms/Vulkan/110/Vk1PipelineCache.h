...
namespace PlatformVK
{
	...
	public:
		...
		ND_ ModulePtr  Create (ModuleMsg::UntypedID_t, GlobalSystemsRef, const CreateInfo::GraphicsPipeline &);
		ND_ ModulePtr  Create (ModuleMsg::UntypedID_t, GlobalSystemsRef, const CreateInfo::ComputePipeline &);
