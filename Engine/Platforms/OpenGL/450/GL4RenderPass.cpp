...
namespace PlatformGL
{
	...
	// methods
	public:
		GL4RenderPass (UntypedID_t, GlobalSystemsRef gs, const CreateInfo::GpuRenderPass &ci);
		~GL4RenderPass ();
...
namespace Platforms
{
	ModulePtr OpenGLObjectsConstructor::CreateGL4RenderPass (ModuleMsg::UntypedID_t id, GlobalSystemsRef gs, const CreateInfo::GpuRenderPass &ci)
	{
		return New< PlatformGL::GL4RenderPass >( id, gs, ci );
	}
