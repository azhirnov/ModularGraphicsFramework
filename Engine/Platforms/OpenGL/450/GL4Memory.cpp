...
=================================================
*/
	bool GL4Memory::_ReadRegion (const DSMsg::ReadRegion &msg)
	{
		BinArrayCRef	data;
...
=================================================
*/
	bool GL4Memory::_WriteRegion (const DSMsg::WriteRegion &msg)
	{
		BytesUL	written;
...
=================================================
*/
	bool GL4Memory::_GpuMemoryRegionChanged (const GpuMsg::GpuMemoryRegionChanged &)
	{
