...
namespace PipelineCompiler
{
	...
	class AngelScriptSerializer final : public ISerializer
	{
	// types
	private:
	...
	public:
		...
		String	GetSourceFileExt () const override	{ return "as"; }
		String	GetHeaderFileExt () const override	{ return "as"; }
