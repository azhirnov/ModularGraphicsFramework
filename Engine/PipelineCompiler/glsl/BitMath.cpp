...
ulong BitScanForward (const ulong x)
{
	...
	return (BIT_SCAN_FORWARD( ulong ))-1;
}

ulong BitScanReverse (const ulong x)
{
	const ulong zero = ulong(0);
	return (BIT_SCAN_REVERSE( ulong ))-1;
}

ulong2 BitScanForward (const ulong2 x)
{
	const ulong2 zero = ulong2(0);
	return (BIT_SCAN_FORWARD( ulong2 ))-1;
}

ulong2 BitScanReverse (const ulong2 x)
{
	const ulong2 zero = ulong2(0);
	return (BIT_SCAN_REVERSE( ulong2 ))-1;
}

ulong3 BitScanForward (const ulong3 x)
{
	const ulong3 zero = ulong3(0);
	return (BIT_SCAN_FORWARD( ulong3 ))-1;
}

ulong3 BitScanReverse (const ulong3 x)
{
	const ulong3 zero = ulong3(0);
	return (BIT_SCAN_REVERSE( ulong3 ))-1;
}

ulong4 BitScanForward (const ulong4 x)
{
	const ulong4 zero = ulong4(0);
	return (BIT_SCAN_FORWARD( ulong4 ))-1;
}

ulong4 BitScanReverse (const ulong4 x)
{
	const ulong4 zero = ulong4(0);
	return (BIT_SCAN_REVERSE( ulong4 ))-1;
}
