...
namespace GXMath
{
	...
	struct TypeCast final : public Noninstancable
	{
		...
		template <typename T>
		ND_ inline static T  ToUNorm (const T &value)
		{
		...
		ND_ inline static Vec<T,I,U>  ToUNorm (const Vec<T,I,U> &value)
		{
			Vec<T,I,U>		res;
		...
		ND_ inline static Vec<T,I,_UID_UNORM>  ToUNorm (const Vec<T,I,_UID_SNORM> &value)
		{
		...
		template <typename T>
		ND_ inline static T  ToSNorm (const T &value)
		{
			STATIC_ASSERT( CompileTime::IsFloat<T> );
		...
		template <typename T, usize I, ulong U>
		ND_ inline static Vec<T,I,U>  ToSNorm (const Vec<T,I,U> &value)
		{
			Vec<T,I,U>		res;
		...
		template <typename T, usize I>
		ND_ inline static Vec<T,I,_UID_SNORM>  ToSNorm (const Vec<T,I,_UID_UNORM> &value)
		{
		...
		ND_ inline static R  UNormToInt (const T &value)
		{
			STATIC_ASSERT( CompileTime::IsFloat<T> );
		...
		ND_ inline static Vec<R,I,U>  UNormToInt (const Vec<T,I,U> &value)
		{
			Vec<R,I,U>		res;
		...
		ND_ inline static Vec<R,I>  UNormToInt (const Vec<T,I,_UID_UNORM> &value)
		{
			Vec<R,I>		res;
			FOR( i, res )	res[i] = UNormToInt<R>( value[i] );
			return res;
		...
		// SNormToInt //
		template <typename R, typename T>
		ND_ inline static R  SNormToInt (const T &value)
		{
			STATIC_ASSERT( CompileTime::IsFloat<T> );
		...
		template <typename R, typename T, usize I, ulong U>
		ND_ inline static Vec<R,I,U>  SNormToInt (const Vec<T,I,U> &value)
		{
			Vec<R,I,U>		res;
		...
		template <typename R, typename T, usize I>
		ND_ inline static Vec<R,I>  SNormToInt (const Vec<T,I,_UID_SNORM> &value)
		{
			Vec<R,I>		res;
			FOR( i, res )	res[i] = SNormToInt<R>( value[i] );
			return res;
		...
		// IntToUNorm //
		template <typename R, typename T>
		ND_ inline static R  IntToUNorm (const T &value)
		{
		...
		template <typename R, typename T, usize I, ulong U>
		ND_ inline static Vec<R,I,_UID_UNORM>  IntToUNorm (const Vec<T,I,U> &value)
		{
		...
		// IntToSNorm //
		template <typename R, typename T>
		ND_ inline static R  IntToSNorm (const T &value)
		{
		...
		template <typename R, typename T, usize I, ulong U>
		ND_ inline static Vec<R,I,_UID_SNORM>  IntToSNorm (const Vec<T,I,U> &value)
		{
