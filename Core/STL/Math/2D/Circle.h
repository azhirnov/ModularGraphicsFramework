...
namespace GXMath
{
	...
	template <typename T, ulong U>
	ND_ inline Rectangle<T,U>  Circle<T,U>::GetAxisAlignedRectangle () const
	{
	...
	template <typename T, ulong U>
	ND_ inline Radians<T>  Circle<T,U>::GetAngle (const Vec_t &point) const
	{
	...
	template <typename T, ulong U>
	ND_ inline Vec<T,2,U>  Circle<T,U>::GetXfromY (const T y) const
	{
		// (x-cx)^2 + (y-cy)^2 = R^2
	...
	template <typename T, ulong U>
	ND_ inline Vec<T,2,U>  Circle<T,U>::GetYfromX (const T x) const
	{
	...
	template <typename T, ulong U>
	ND_ inline Line2<T,U>  Circle<T,U>::GetChord (Radians<T> startAngle, Radians<T> endAngle) const
	{
	...
	template <typename T, ulong U>
	ND_ inline bool  Circle<T,U>::IsInnerPoint (const Vec_t &point) const
	{
	...
	template <typename T, ulong U>
	ND_ inline bool  Circle<T,U>::IsInnerLine (const Line_t &line) const
	{
	...
	template <typename T, ulong U>
	ND_ inline bool  Circle<T,U>::IsInnerRect (const Rect_t &rect) const
	{
	...
	template <typename T, ulong U>
	ND_ inline bool  Circle<T,U>::IsInnerCircle (const Self &circle) const
	{
	...
	template <typename T, ulong U>
	ND_ inline bool  Circle<T,U>::IntersectLine (const Line_t &line) const
	{
		TODO( "IntersectLine" );
	...
	template <typename T, ulong U>
	ND_ inline bool  Circle<T,U>::IntersectRect (const Rect_t &rect) const
	{
	...
	template <typename T, ulong U>
	ND_ inline bool  Circle<T,U>::IntersectCircle (const Self &circle) const
	{
...
namespace GXTypes
{
	...
	{
		ND_ HashResult  operator () (const GXMath::Circle<T,U> &x) const noexcept
		{
