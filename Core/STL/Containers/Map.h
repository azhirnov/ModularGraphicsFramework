...
namespace _types_hidden_
{
	...
	private:
		...
		struct _TCustomSearch
		{
			Obj &	_ref;

			_TCustomSearch (Obj &ref) : _ref(ref) {}
		...
		using _CustomSearch			= _TCustomSearch< Self >;
		using _ConstCustomSearch	= _TCustomSearch< const Self >;


	public:
		_CustomSearch const			CustomSearch ()			{ return _CustomSearch( *this ); }
		_ConstCustomSearch const	CustomSearch ()	const	{ return _ConstCustomSearch( *this ); }
	};
