...
ExternalProject_Add( "External.LunarGLASS"
		...
		# configure
		SOURCE_DIR		"${EXTERNALS_PATH}/cmake/LunarGLASS"
		...
		CMAKE_ARGS		"-DCMAKE_CONFIGURATION_TYPES=${EXTERNAL_CONFIGURATION_TYPES}"
						...
						"-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=${CMAKE_BINARY_DIR}/LunarGLASS_bin"
						"-DCMAKE_ARCHIVE_OUTPUT_DIRECTORY=${CMAKE_BINARY_DIR}/LunarGLASS_bin"
						${EXTERNAL_BUILD_TARGET_FLAGS}
		LOG_CONFIGURE 	1
		# build
		BINARY_DIR		"${CMAKE_BINARY_DIR}/LunarGLASS_bin"
...
if ( ${CONFIGURATION_DEPENDENT_PATH} )
	foreach ( DEP ${LUNARGLASS_DEPS} )
		set( LUNARGLASS_DEPS_SRC "${LUNARGLASS_DEPS_SRC}" "${CMAKE_BINARY_DIR}/LunarGLASS_bin/$<CONFIG>/${CMAKE_STATIC_LIBRARY_PREFIX}${DEP}${CMAKE_STATIC_LIBRARY_SUFFIX}" )
	endforeach ()
	foreach ( DEP ${LUNARGLASS_GLSLANG_DEPS} )
		set( LUNARGLASS_DEPS_SRC "${LUNARGLASS_DEPS_SRC}" "${CMAKE_BINARY_DIR}/LunarGLASS_bin/$<CONFIG>/${CMAKE_STATIC_LIBRARY_PREFIX}${DEP}${CMAKE_STATIC_LIBRARY_SUFFIX}" )
	endforeach ()
	foreach ( DEP ${LUNARGLASS_LLVM_DEPS} )
		set( LUNARGLASS_DEPS_SRC "${LUNARGLASS_DEPS_SRC}" "${CMAKE_BINARY_DIR}/LunarGLASS_bin/LunarGLASS/Core/LLVM/llvm-3.4/lib/$<CONFIG>/${CMAKE_STATIC_LIBRARY_PREFIX}${DEP}${CMAKE_STATIC_LIBRARY_SUFFIX}" )
	endforeach ()
else ()
	foreach ( DEP ${LUNARGLASS_DEPS} )
		set( LUNARGLASS_DEPS_SRC "${LUNARGLASS_DEPS_SRC}" "${CMAKE_BINARY_DIR}/LunarGLASS_bin/${CMAKE_STATIC_LIBRARY_PREFIX}${DEP}${CMAKE_STATIC_LIBRARY_SUFFIX}" )
	endforeach ()
	foreach ( DEP ${LUNARGLASS_GLSLANG_DEPS} )
		set( LUNARGLASS_DEPS_SRC "${LUNARGLASS_DEPS_SRC}" "${CMAKE_BINARY_DIR}/LunarGLASS_bin/${CMAKE_STATIC_LIBRARY_PREFIX}${DEP}${CMAKE_STATIC_LIBRARY_SUFFIX}" )
	endforeach ()
	foreach ( DEP ${LUNARGLASS_LLVM_DEPS} )
		set( LUNARGLASS_DEPS_SRC "${LUNARGLASS_DEPS_SRC}" "${CMAKE_BINARY_DIR}/LunarGLASS_bin/LunarGLASS/Core/LLVM/llvm-3.4/lib/${CMAKE_STATIC_LIBRARY_PREFIX}${DEP}${CMAKE_STATIC_LIBRARY_SUFFIX}" )
	endforeach ()
endif ()
