...
#define GL4_CORE_FUNCTIONS( _buildFunc_ ) \
	...
	_buildFunc_( void, TransformFeedbackBufferRange, ( GLuint xfb , GLuint index , GLuint buffer , GLintptr offset , GLsizei size ), (void)(0) ) \
	...
	_buildFunc_( void, NamedBufferStorage, ( GLuint buffer , GLsizei size , const void * data , GLbitfield flags ), (void)(0) ) \
	_buildFunc_( void, NamedBufferData, ( GLuint buffer , GLsizei size , const void * data , GLenum usage ), (void)(0) ) \
	_buildFunc_( void, NamedBufferSubData, ( GLuint buffer , GLintptr offset , GLsizei size , const void * data ), (void)(0) ) \
	_buildFunc_( void, CopyNamedBufferSubData, ( GLuint readBuffer , GLuint writeBuffer , GLintptr readOffset , GLintptr writeOffset , GLsizei size ), (void)(0) ) \
	...
	_buildFunc_( void, ClearNamedBufferSubData, ( GLuint buffer , GLenum internalformat , GLintptr offset , GLsizei size , GLenum format , GLenum type , const void * data ), (void)(0) ) \
	_buildFunc_( void *, MapNamedBuffer, ( GLuint buffer , GLenum access ), (void *)(0) ) \
	_buildFunc_( void *, MapNamedBufferRange, ( GLuint buffer , GLintptr offset , GLsizei length , GLbitfield access ), (void *)(0) ) \
	_buildFunc_( GLboolean, UnmapNamedBuffer, ( GLuint buffer ), (GLboolean)(0) ) \
	_buildFunc_( void, FlushMappedNamedBufferRange, ( GLuint buffer , GLintptr offset , GLsizei length ), (void)(0) ) \
	...
	_buildFunc_( void, GetNamedBufferSubData, ( GLuint buffer , GLintptr offset , GLsizei size , void * data ), (void)(0) ) \
	...
	_buildFunc_( void, ClearNamedFramebufferfi, ( GLuint framebuffer , GLenum buffer , const GLfloat depth , GLint stencil ), (void)(0) ) \
	...
	_buildFunc_( void, TextureBufferRange, ( GLuint texture , GLenum internalformat , GLuint buffer , GLintptr offset , GLsizei size ), (void)(0) ) \
