...
#define CL2_GL_FUNCTIONS( _buildFunc_ ) \
	...
	_buildFunc_( cl_mem, CreateFromGLTexture, ( cl_context context , cl_mem_flags flags , cl_GLenum target , cl_GLint miplevel , cl_GLuint texture , cl_int * errcode_ret ) , cl_mem() ) \
