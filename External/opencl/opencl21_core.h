...
#define CL2_CORE_FUNCTIONS( _buildFunc_ ) \
	...
	_buildFunc_( void * , SVMAlloc, ( cl_context context , cl_svm_mem_flags flags , size_t size , cl_uint alignment ) , nullptr ) \
	...
	_buildFunc_( void * , EnqueueMapBuffer, ( cl_command_queue command_queue , cl_mem buffer , cl_bool blocking_map , cl_map_flags map_flags , size_t offset , size_t size , cl_uint num_events_in_wait_list , const cl_event * event_wait_list , cl_event * event , cl_int * errcode_ret ) , nullptr ) \
