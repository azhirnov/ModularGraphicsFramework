...
#define VK1_CORE_FUNCTIONS( _buildFunc_ ) \
	...
	_buildFunc_( void, vkGetPhysicalDeviceExternalFenceProperties, ( VkPhysicalDevice physicalDevice , const VkPhysicalDeviceExternalFenceInfo * pExternalFenceInfo , VkExternalFenceProperties * pExternalFenceProperties ) , (void)(0) ) \
	...
	_buildFunc_( void, vkGetDeviceGroupPeerMemoryFeaturesKHR, ( VkDevice device , uint32_t heapIndex , uint32_t localDeviceIndex , uint32_t remoteDeviceIndex , VkPeerMemoryFeatureFlags * pPeerMemoryFeatures ) , (void)(0) ) \
