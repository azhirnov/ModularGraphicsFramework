...
#define VK1_CORE_FUNCTIONS( _buildFunc_ ) \
	...
	_buildFunc_( void, vkCmdSetLineWidth, ( VkCommandBuffer commandBuffer , float lineWidth ) , (void)(0) ) \
	_buildFunc_( void, vkCmdSetDepthBias, ( VkCommandBuffer commandBuffer , float depthBiasConstantFactor , float depthBiasClamp , float depthBiasSlopeFactor ) , (void)(0) ) \
	_buildFunc_( void, vkCmdSetBlendConstants, ( VkCommandBuffer commandBuffer , const float blendConstants [ 4 ] ) , (void)(0) ) \
	_buildFunc_( void, vkCmdSetDepthBounds, ( VkCommandBuffer commandBuffer , float minDepthBounds , float maxDepthBounds ) , (void)(0) ) \
	_buildFunc_( void, vkCmdSetStencilCompareMask, ( VkCommandBuffer commandBuffer , VkStencilFaceFlags faceMask , uint32_t compareMask ) , (void)(0) ) \
	_buildFunc_( void, vkCmdSetStencilWriteMask, ( VkCommandBuffer commandBuffer , VkStencilFaceFlags faceMask , uint32_t writeMask ) , (void)(0) ) \
	_buildFunc_( void, vkCmdSetStencilReference, ( VkCommandBuffer commandBuffer , VkStencilFaceFlags faceMask , uint32_t reference ) , (void)(0) ) \
	_buildFunc_( void, vkCmdBindDescriptorSets, ( VkCommandBuffer commandBuffer , VkPipelineBindPoint pipelineBindPoint , VkPipelineLayout layout , uint32_t firstSet , uint32_t descriptorSetCount , const VkDescriptorSet * pDescriptorSets , uint32_t dynamicOffsetCount , const uint32_t * pDynamicOffsets ) , (void)(0) ) \
	_buildFunc_( void, vkCmdBindIndexBuffer, ( VkCommandBuffer commandBuffer , VkBuffer buffer , VkDeviceSize offset , VkIndexType indexType ) , (void)(0) ) \
	_buildFunc_( void, vkCmdBindVertexBuffers, ( VkCommandBuffer commandBuffer , uint32_t firstBinding , uint32_t bindingCount , const VkBuffer * pBuffers , const VkDeviceSize * pOffsets ) , (void)(0) ) \
	_buildFunc_( void, vkCmdDraw, ( VkCommandBuffer commandBuffer , uint32_t vertexCount , uint32_t instanceCount , uint32_t firstVertex , uint32_t firstInstance ) , (void)(0) ) \
	_buildFunc_( void, vkCmdDrawIndexed, ( VkCommandBuffer commandBuffer , uint32_t indexCount , uint32_t instanceCount , uint32_t firstIndex , int32_t vertexOffset , uint32_t firstInstance ) , (void)(0) ) \
	_buildFunc_( void, vkCmdDrawIndirect, ( VkCommandBuffer commandBuffer , VkBuffer buffer , VkDeviceSize offset , uint32_t drawCount , uint32_t stride ) , (void)(0) ) \
	_buildFunc_( void, vkCmdDrawIndexedIndirect, ( VkCommandBuffer commandBuffer , VkBuffer buffer , VkDeviceSize offset , uint32_t drawCount , uint32_t stride ) , (void)(0) ) \
	_buildFunc_( void, vkCmdDispatch, ( VkCommandBuffer commandBuffer , uint32_t groupCountX , uint32_t groupCountY , uint32_t groupCountZ ) , (void)(0) ) \
	_buildFunc_( void, vkCmdDispatchIndirect, ( VkCommandBuffer commandBuffer , VkBuffer buffer , VkDeviceSize offset ) , (void)(0) ) \
	_buildFunc_( void, vkCmdCopyBuffer, ( VkCommandBuffer commandBuffer , VkBuffer srcBuffer , VkBuffer dstBuffer , uint32_t regionCount , const VkBufferCopy * pRegions ) , (void)(0) ) \
	_buildFunc_( void, vkCmdCopyImage, ( VkCommandBuffer commandBuffer , VkImage srcImage , VkImageLayout srcImageLayout , VkImage dstImage , VkImageLayout dstImageLayout , uint32_t regionCount , const VkImageCopy * pRegions ) , (void)(0) ) \
	_buildFunc_( void, vkCmdBlitImage, ( VkCommandBuffer commandBuffer , VkImage srcImage , VkImageLayout srcImageLayout , VkImage dstImage , VkImageLayout dstImageLayout , uint32_t regionCount , const VkImageBlit * pRegions , VkFilter filter ) , (void)(0) ) \
	_buildFunc_( void, vkCmdCopyBufferToImage, ( VkCommandBuffer commandBuffer , VkBuffer srcBuffer , VkImage dstImage , VkImageLayout dstImageLayout , uint32_t regionCount , const VkBufferImageCopy * pRegions ) , (void)(0) ) \
	_buildFunc_( void, vkCmdCopyImageToBuffer, ( VkCommandBuffer commandBuffer , VkImage srcImage , VkImageLayout srcImageLayout , VkBuffer dstBuffer , uint32_t regionCount , const VkBufferImageCopy * pRegions ) , (void)(0) ) \
	_buildFunc_( void, vkCmdUpdateBuffer, ( VkCommandBuffer commandBuffer , VkBuffer dstBuffer , VkDeviceSize dstOffset , VkDeviceSize dataSize , const void * pData ) , (void)(0) ) \
	_buildFunc_( void, vkCmdFillBuffer, ( VkCommandBuffer commandBuffer , VkBuffer dstBuffer , VkDeviceSize dstOffset , VkDeviceSize size , uint32_t data ) , (void)(0) ) \
	_buildFunc_( void, vkCmdClearColorImage, ( VkCommandBuffer commandBuffer , VkImage image , VkImageLayout imageLayout , const VkClearColorValue * pColor , uint32_t rangeCount , const VkImageSubresourceRange * pRanges ) , (void)(0) ) \
	_buildFunc_( void, vkCmdClearDepthStencilImage, ( VkCommandBuffer commandBuffer , VkImage image , VkImageLayout imageLayout , const VkClearDepthStencilValue * pDepthStencil , uint32_t rangeCount , const VkImageSubresourceRange * pRanges ) , (void)(0) ) \
	_buildFunc_( void, vkCmdClearAttachments, ( VkCommandBuffer commandBuffer , uint32_t attachmentCount , const VkClearAttachment * pAttachments , uint32_t rectCount , const VkClearRect * pRects ) , (void)(0) ) \
	_buildFunc_( void, vkCmdResolveImage, ( VkCommandBuffer commandBuffer , VkImage srcImage , VkImageLayout srcImageLayout , VkImage dstImage , VkImageLayout dstImageLayout , uint32_t regionCount , const VkImageResolve * pRegions ) , (void)(0) ) \
	_buildFunc_( void, vkCmdSetEvent, ( VkCommandBuffer commandBuffer , VkEvent event , VkPipelineStageFlags stageMask ) , (void)(0) ) \
	_buildFunc_( void, vkCmdResetEvent, ( VkCommandBuffer commandBuffer , VkEvent event , VkPipelineStageFlags stageMask ) , (void)(0) ) \
	_buildFunc_( void, vkCmdWaitEvents, ( VkCommandBuffer commandBuffer , uint32_t eventCount , const VkEvent * pEvents , VkPipelineStageFlags srcStageMask , VkPipelineStageFlags dstStageMask , uint32_t memoryBarrierCount , const VkMemoryBarrier * pMemoryBarriers , uint32_t bufferMemoryBarrierCount , const VkBufferMemoryBarrier * pBufferMemoryBarriers , uint32_t imageMemoryBarrierCount , const VkImageMemoryBarrier * pImageMemoryBarriers ) , (void)(0) ) \
	_buildFunc_( void, vkCmdPipelineBarrier, ( VkCommandBuffer commandBuffer , VkPipelineStageFlags srcStageMask , VkPipelineStageFlags dstStageMask , VkDependencyFlags dependencyFlags , uint32_t memoryBarrierCount , const VkMemoryBarrier * pMemoryBarriers , uint32_t bufferMemoryBarrierCount , const VkBufferMemoryBarrier * pBufferMemoryBarriers , uint32_t imageMemoryBarrierCount , const VkImageMemoryBarrier * pImageMemoryBarriers ) , (void)(0) ) \
	_buildFunc_( void, vkCmdBeginQuery, ( VkCommandBuffer commandBuffer , VkQueryPool queryPool , uint32_t query , VkQueryControlFlags flags ) , (void)(0) ) \
	_buildFunc_( void, vkCmdEndQuery, ( VkCommandBuffer commandBuffer , VkQueryPool queryPool , uint32_t query ) , (void)(0) ) \
	_buildFunc_( void, vkCmdResetQueryPool, ( VkCommandBuffer commandBuffer , VkQueryPool queryPool , uint32_t firstQuery , uint32_t queryCount ) , (void)(0) ) \
	_buildFunc_( void, vkCmdWriteTimestamp, ( VkCommandBuffer commandBuffer , VkPipelineStageFlagBits pipelineStage , VkQueryPool queryPool , uint32_t query ) , (void)(0) ) \
	_buildFunc_( void, vkCmdCopyQueryPoolResults, ( VkCommandBuffer commandBuffer , VkQueryPool queryPool , uint32_t firstQuery , uint32_t queryCount , VkBuffer dstBuffer , VkDeviceSize dstOffset , VkDeviceSize stride , VkQueryResultFlags flags ) , (void)(0) ) \
	_buildFunc_( void, vkCmdPushConstants, ( VkCommandBuffer commandBuffer , VkPipelineLayout layout , VkShaderStageFlags stageFlags , uint32_t offset , uint32_t size , const void * pValues ) , (void)(0) ) \
	_buildFunc_( void, vkCmdBeginRenderPass, ( VkCommandBuffer commandBuffer , const VkRenderPassBeginInfo * pRenderPassBegin , VkSubpassContents contents ) , (void)(0) ) \
	...
	_buildFunc_( void, vkGetPhysicalDeviceFeatures2KHR, ( VkPhysicalDevice physicalDevice , VkPhysicalDeviceFeatures2KHR * pFeatures ) , (void)(0) ) \
	_buildFunc_( void, vkGetPhysicalDeviceProperties2KHR, ( VkPhysicalDevice physicalDevice , VkPhysicalDeviceProperties2KHR * pProperties ) , (void)(0) ) \
	_buildFunc_( void, vkGetPhysicalDeviceFormatProperties2KHR, ( VkPhysicalDevice physicalDevice , VkFormat format , VkFormatProperties2KHR * pFormatProperties ) , (void)(0) ) \
	_buildFunc_( VkResult, vkGetPhysicalDeviceImageFormatProperties2KHR, ( VkPhysicalDevice physicalDevice , const VkPhysicalDeviceImageFormatInfo2KHR * pImageFormatInfo , VkImageFormatProperties2KHR * pImageFormatProperties ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( void, vkGetPhysicalDeviceQueueFamilyProperties2KHR, ( VkPhysicalDevice physicalDevice , uint32_t * pQueueFamilyPropertyCount , VkQueueFamilyProperties2KHR * pQueueFamilyProperties ) , (void)(0) ) \
	_buildFunc_( void, vkGetPhysicalDeviceMemoryProperties2KHR, ( VkPhysicalDevice physicalDevice , VkPhysicalDeviceMemoryProperties2KHR * pMemoryProperties ) , (void)(0) ) \
	_buildFunc_( void, vkGetPhysicalDeviceSparseImageFormatProperties2KHR, ( VkPhysicalDevice physicalDevice , const VkPhysicalDeviceSparseImageFormatInfo2KHR * pFormatInfo , uint32_t * pPropertyCount , VkSparseImageFormatProperties2KHR * pProperties ) , (void)(0) ) \
	_buildFunc_( void, vkTrimCommandPoolKHR, ( VkDevice device , VkCommandPool commandPool , VkCommandPoolTrimFlagsKHR flags ) , (void)(0) ) \
	...
	_buildFunc_( VkResult, vkCreateDescriptorUpdateTemplateKHR, ( VkDevice device , const VkDescriptorUpdateTemplateCreateInfoKHR * pCreateInfo , const VkAllocationCallbacks * pAllocator , VkDescriptorUpdateTemplateKHR * pDescriptorUpdateTemplate ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( void, vkDestroyDescriptorUpdateTemplateKHR, ( VkDevice device , VkDescriptorUpdateTemplateKHR descriptorUpdateTemplate , const VkAllocationCallbacks * pAllocator ) , (void)(0) ) \
	_buildFunc_( void, vkUpdateDescriptorSetWithTemplateKHR, ( VkDevice device , VkDescriptorSet descriptorSet , VkDescriptorUpdateTemplateKHR descriptorUpdateTemplate , const void * pData ) , (void)(0) ) \
	_buildFunc_( void, vkCmdPushDescriptorSetWithTemplateKHR, ( VkCommandBuffer commandBuffer , VkDescriptorUpdateTemplateKHR descriptorUpdateTemplate , VkPipelineLayout layout , uint32_t set , const void * pData ) , (void)(0) ) \
	...
	_buildFunc_( VkResult, vkDebugMarkerSetObjectTagEXT, ( VkDevice device , VkDebugMarkerObjectTagInfoEXT * pTagInfo ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( VkResult, vkDebugMarkerSetObjectNameEXT, ( VkDevice device , VkDebugMarkerObjectNameInfoEXT * pNameInfo ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( void, vkCmdDebugMarkerBeginEXT, ( VkCommandBuffer commandBuffer , VkDebugMarkerMarkerInfoEXT * pMarkerInfo ) , (void)(0) ) \
	_buildFunc_( void, vkCmdDebugMarkerEndEXT, ( VkCommandBuffer commandBuffer ) , (void)(0) ) \
	_buildFunc_( void, vkCmdDebugMarkerInsertEXT, ( VkCommandBuffer commandBuffer , VkDebugMarkerMarkerInfoEXT * pMarkerInfo ) , (void)(0) ) \
	...
	_buildFunc_( void, vkGetDeviceGroupPeerMemoryFeaturesKHX, ( VkDevice device , uint32_t heapIndex , uint32_t localDeviceIndex , uint32_t remoteDeviceIndex , VkPeerMemoryFeatureFlagsKHX * pPeerMemoryFeatures ) , (void)(0) ) \
	_buildFunc_( VkResult, vkBindBufferMemory2KHX, ( VkDevice device , uint32_t bindInfoCount , const VkBindBufferMemoryInfoKHX * pBindInfos ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( VkResult, vkBindImageMemory2KHX, ( VkDevice device , uint32_t bindInfoCount , const VkBindImageMemoryInfoKHX * pBindInfos ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( void, vkCmdSetDeviceMaskKHX, ( VkCommandBuffer commandBuffer , uint32_t deviceMask ) , (void)(0) ) \
	_buildFunc_( VkResult, vkGetDeviceGroupPresentCapabilitiesKHX, ( VkDevice device , VkDeviceGroupPresentCapabilitiesKHX * pDeviceGroupPresentCapabilities ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( VkResult, vkGetDeviceGroupSurfacePresentModesKHX, ( VkDevice device , VkSurfaceKHR surface , VkDeviceGroupPresentModeFlagsKHX * pModes ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( VkResult, vkAcquireNextImage2KHX, ( VkDevice device , const VkAcquireNextImageInfoKHX * pAcquireInfo , uint32_t * pImageIndex ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( void, vkCmdDispatchBaseKHX, ( VkCommandBuffer commandBuffer , uint32_t baseGroupX , uint32_t baseGroupY , uint32_t baseGroupZ , uint32_t groupCountX , uint32_t groupCountY , uint32_t groupCountZ ) , (void)(0) ) \
	_buildFunc_( VkResult, vkGetPhysicalDevicePresentRectanglesKHX, ( VkPhysicalDevice physicalDevice , VkSurfaceKHR surface , uint32_t * pRectCount , VkRect2D * pRects ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( VkResult, vkEnumeratePhysicalDeviceGroupsKHX, ( VkInstance instance , uint32_t * pPhysicalDeviceGroupCount , VkPhysicalDeviceGroupPropertiesKHX * pPhysicalDeviceGroupProperties ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( void, vkGetPhysicalDeviceExternalBufferPropertiesKHX, ( VkPhysicalDevice physicalDevice , const VkPhysicalDeviceExternalBufferInfoKHX * pExternalBufferInfo , VkExternalBufferPropertiesKHX * pExternalBufferProperties ) , (void)(0) ) \
	_buildFunc_( VkResult, vkGetMemoryFdKHX, ( VkDevice device , VkDeviceMemory memory , VkExternalMemoryHandleTypeFlagBitsKHX handleType , int * pFd ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( VkResult, vkGetMemoryFdPropertiesKHX, ( VkDevice device , VkExternalMemoryHandleTypeFlagBitsKHX handleType , int fd , VkMemoryFdPropertiesKHX * pMemoryFdProperties ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( void, vkGetPhysicalDeviceExternalSemaphorePropertiesKHX, ( VkPhysicalDevice physicalDevice , const VkPhysicalDeviceExternalSemaphoreInfoKHX * pExternalSemaphoreInfo , VkExternalSemaphorePropertiesKHX * pExternalSemaphoreProperties ) , (void)(0) ) \
	_buildFunc_( VkResult, vkImportSemaphoreFdKHX, ( VkDevice device , const VkImportSemaphoreFdInfoKHX * pImportSemaphoreFdInfo ) , VK_RESULT_MAX_ENUM ) \
	_buildFunc_( VkResult, vkGetSemaphoreFdKHX, ( VkDevice device , VkSemaphore semaphore , VkExternalSemaphoreHandleTypeFlagBitsKHX handleType , int * pFd ) , VK_RESULT_MAX_ENUM ) \
