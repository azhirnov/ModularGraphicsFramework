...
=================================================
*/
bool PApp::_OnWindowClosed (const OSMsg::WindowAfterDestroy &)
{
	looping = false;
	return true;
}
...
=================================================
*/
bool PApp::_Draw (const ModuleMsg::Update &)
{
	if ( not looping )
		return false;
...
=================================================
*/
bool PApp::_GInit (const GpuMsg::DeviceCreated &)
{
...
=================================================
*/
bool PApp::_GDelete (const GpuMsg::DeviceBeforeDestroy &)
{
	gpuThread	= null;
	syncManager	= null;
	cmdBuilder	= null;
