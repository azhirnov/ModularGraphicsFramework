...
=================================================
*/
bool SApp::_OnWindowClosed (const Message<OSMsg::WindowAfterDestroy> &)
{
	looping = false;
	return true;
}
...
=================================================
*/
bool SApp::_Draw (const Message< ModuleMsg::Update > &)
{
...
=================================================
*/
bool SApp::_GInit (const Message< GpuMsg::DeviceCreated > &)
{
...
=================================================
*/
bool SApp::_GDelete (const Message< GpuMsg::DeviceBeforeDestroy > &)
{
	gpuThread	= null;
	syncManager	= null;
	cmdBuilder	= null;
...
=================================================
*/
bool SApp::_GInit2 (const Message< GpuMsg::DeviceCreated > &)
{
	sharedGpu.syncManager = sharedGpu.gpuThread->GetModuleByMsg<CompileTime::TypeListFrom< Message<GpuMsg::CreateFence> >>();
...
=================================================
*/
bool SApp::_GDelete2 (const Message< GpuMsg::DeviceBeforeDestroy > &)
{
