...
namespace SWShaderLang
{
		...
		// shader
	{
		...
		for(; (UInt( y ) < UInt( 4 )); ++( y ))
		{
			...
			for(; (UInt( x ) < UInt( 4 )); ++( x ))
			{
				const Float4 diff = ((sharedMemory[idx]) - (sharedMemory[(UInt( x ) + (UInt( y ) * UInt( 4 )))]));
...
void main ()
{
	...
	for(; (uint( y ) < uint( 4 )); ++( y ))
	{
		...
		for(; (uint( x ) < uint( 4 )); ++( x ))
		{
			const vec4 diff = ((sharedMemory[idx]) - (sharedMemory[(uint( x ) + (uint( y ) * uint( 4 )))]));
			value = MaxMag(value, diff);
		}
		;
	}
...
0x00000040, 0x00000040, 0x00000000, 0x00000001, 0x0003003E, 0x0000003A, 0x00000041, 0x00040008, 0x00000001, 0x0000002D, 0x00000000, 0x0004003D, 
...
0x0000002E, 0x00000000, 0x0004003D, 0x00000037, 0x0000004C, 0x00000043, 0x0004003D, 0x0000004D, 0x00000050, 0x0000004F, 0x0004003D, 0x00000038, 
...
0x0003003E, 0x00000054, 0x00000052, 0x00040008, 0x00000001, 0x0000002F, 0x00000000, 0x000400E0, 0x0000002C, 0x00000028, 0x00000024, 0x00040008, 
0x00000001, 0x00000030, 0x00000000, 0x0003003E, 0x00000056, 0x00000058, 0x00040008, 0x00000001, 0x00000031, 0x00000000, 0x0003003E, 0x00000059, 
0x0000005A, 0x000200F9, 0x0000005B, 0x00040008, 0x00000001, 0x00000032, 0x00000000, 0x000200F8, 0x0000005B, 0x000400F6, 0x0000005D, 0x0000005E, 
0x00000000, 0x000200F9, 0x0000005F, 0x000200F8, 0x0000005F, 0x0004003D, 0x00000037, 0x00000060, 0x00000059, 0x0004007C, 0x00000023, 0x00000061, 
0x00000060, 0x000500B0, 0x00000015, 0x00000063, 0x00000061, 0x00000062, 0x000400FA, 0x00000063, 0x0000005C, 0x0000005D, 0x000200F8, 0x0000005C, 
0x00040008, 0x00000001, 0x00000034, 0x00000000, 0x0003003E, 0x00000064, 0x0000005A, 0x000200F9, 0x00000065, 0x00040008, 0x00000001, 0x00000035, 
0x00000000, 0x000200F8, 0x00000065, 0x000400F6, 0x00000067, 0x00000068, 0x00000000, 0x000200F9, 0x00000069, 0x000200F8, 0x00000069, 0x0004003D, 
0x00000037, 0x0000006A, 0x00000064, 0x0004007C, 0x00000023, 0x0000006B, 0x0000006A, 0x000500B0, 0x00000015, 0x0000006C, 0x0000006B, 0x00000062, 
0x000400FA, 0x0000006C, 0x00000066, 0x00000067, 0x000200F8, 0x00000066, 0x00040008, 0x00000001, 0x00000037, 0x00000000, 0x0004003D, 0x00000037, 
0x0000006E, 0x00000043, 0x00050041, 0x00000053, 0x0000006F, 0x0000004B, 0x0000006E, 0x0004003D, 0x0000000D, 0x00000070, 0x0000006F, 0x0004003D, 
0x00000037, 0x00000071, 0x00000064, 0x0004007C, 0x00000023, 0x00000072, 0x00000071, 0x0004003D, 0x00000037, 0x00000073, 0x00000059, 0x0004007C, 
0x00000023, 0x00000074, 0x00000073, 0x00050084, 0x00000023, 0x00000075, 0x00000074, 0x00000062, 0x00050080, 0x00000023, 0x00000076, 0x00000072, 
0x00000075, 0x00050041, 0x00000053, 0x00000077, 0x0000004B, 0x00000076, 0x0004003D, 0x0000000D, 0x00000078, 0x00000077, 0x00050083, 0x0000000D, 
0x00000079, 0x00000070, 0x00000078, 0x0003003E, 0x0000006D, 0x00000079, 0x00040008, 0x00000001, 0x00000038, 0x00000000, 0x0004003D, 0x0000000D, 
0x0000007A, 0x00000056, 0x0004003D, 0x0000000D, 0x0000007B, 0x0000006D, 0x00060039, 0x0000000D, 0x0000007C, 0x00000011, 0x0000007A, 0x0000007B, 
0x0003003E, 0x00000056, 0x0000007C, 0x000200F9, 0x00000068, 0x000200F8, 0x00000068, 0x00040008, 0x00000001, 0x00000035, 0x00000000, 0x0004003D, 
0x00000037, 0x0000007D, 0x00000064, 0x00050080, 0x00000037, 0x0000007F, 0x0000007D, 0x0000007E, 0x0003003E, 0x00000064, 0x0000007F, 0x000200F9, 
...
0x00000037, 0x00000080, 0x00000059, 0x00050080, 0x00000037, 0x00000081, 0x00000080, 0x0000007E, 0x0003003E, 0x00000059, 0x00000081, 0x000200F9, 
0x0000005B, 0x000200F8, 0x0000005D, 0x00040008, 0x00000001, 0x0000003D, 0x00000000, 0x0004003D, 0x0000004D, 0x00000083, 0x00000082, 0x0004003D, 
0x00000038, 0x00000084, 0x0000003A, 0x0004003D, 0x0000000D, 0x00000085, 0x00000056, 0x00040063, 0x00000083, 0x00000084, 0x00000085, 0x000100FD, 
...
float MaxMag_f1_af1_a (const float a, const float b);
float4 MaxMag_vf4_avf4_a (const float4 a, const float4 b);
...
float4 MaxMag_vf4_avf4_a (const float4 a, const float4 b)
{
	return ((float4)( MaxMag_f1_af1_a(a.x, b.x), MaxMag_f1_af1_a(a.y, b.y), MaxMag_f1_af1_a(a.z, b.z), MaxMag_f1_af1_a(a.w, b.w) ));
}
...

{
	...
	float4 value = ((float4)( 0.0 ));
	int y = ((int)( 0 ));
	for(; (convert_uint( y ) < ((uint)( 4 ))); ++( y ))
	{
		int x = ((int)( 0 ));
		for(; (convert_uint( x ) < ((uint)( 4 ))); ++( x ))
		{
			const float4 diff = ((sharedMemory[idx]) - (sharedMemory[(convert_uint( x ) + (convert_uint( y ) * ((uint)( 4 ))))]));
			value = MaxMag_vf4_avf4_a(value, diff);
		}
		;
	}
	;
